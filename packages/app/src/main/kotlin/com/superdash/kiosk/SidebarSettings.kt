...
enum class SidebarPosition(
    ...
    @SerialName("left")
    Left("left", R.string.settings_sidebar_position_left),

    @SerialName("right")
    Right("right", R.string.settings_sidebar_position_right),

    @SerialName("top")
    Top("top", R.string.settings_sidebar_position_top),

    @SerialName("bottom")
    Bottom("bottom", R.string.settings_sidebar_position_bottom),
    ;
