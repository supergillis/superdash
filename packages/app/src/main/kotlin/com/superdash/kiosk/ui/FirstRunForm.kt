...
fun FirstRunForm(
    ...
    Column(
        ...
        Text(stringResource(R.string.setup_welcome_title), style = MaterialTheme.typography.headlineMedium)
        ...
        Text(stringResource(R.string.setup_ha_url_intro))
        Spacer(Modifier.height(16.dp))
        OutlinedTextField(
            value = input,
            onValueChange = { input = it },
            label = { Text(stringResource(R.string.setup_ha_url_label)) },
            placeholder = { Text(stringResource(R.string.setup_ha_url_placeholder)) },
            singleLine = true,
        ...
        Button(
            ...
            Text(
                if (banner != null) {
                    stringResource(R.string.setup_sign_in_again_button)
                } else {
