    ...
    Row(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            SettingsBackButton(
                ...
                contentDescription = stringResource(R.string.settings_exit_content_description),
            )
            HorizontalDivider()
            Column(
                modifier =
    ...
    Column(
        ...
        if (destination is SettingsDestination.Child) {
            ...
            SettingsDetailHeader(
                ...
                summary = destination.summaryRes()?.let { stringResource(it) },
                modifier =
                    Modifier
                        .fillMaxWidth()
...
private fun SettingsBackButton(
    ...
    contentDescription: String = stringResource(R.string.settings_back_content_description),
) {
    IconButton(
        onClick = onBackClick,
        modifier =
...
private fun SettingsTopLevelContent(
    ...
    for (destination in SettingsDestination.topLevel) {
        SettingsNavigationRow(
            ...
            supportingText = stringResource(destination.summaryRes),
