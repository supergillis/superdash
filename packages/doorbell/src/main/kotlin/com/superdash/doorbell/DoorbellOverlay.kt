...
import com.superdash.doorbell.R
...
fun DoorbellOverlay(
    ...
    val cameraUnavailable = stringResource(R.string.doorbell_camera_unavailable)
    val resolveFailedMessage =
        (streamState as? DoorbellStreamState.Failed)?.let { it.reason ?: cameraUnavailable }
    ...
    Box(
        ...
        if (errorMessage == null && !firstFrameRendered) {
            Column(
                ...
                Text(
                    stringResource(R.string.doorbell_connecting),
                    color = Color.White,
        ...
        IconButton(
            ...
            Icon(Icons.Default.Close, contentDescription = stringResource(R.string.doorbell_close), tint = Color.White)
        }
        FilledIconButton(
            ...
            Icon(Icons.Default.Mic, contentDescription = stringResource(R.string.doorbell_push_to_talk))
        }
    }
}
...
private fun StreamPlayer(
    ...
    val streamInterruptedMessage = stringResource(R.string.doorbell_stream_interrupted)
        ...
        val listener =
            object : Player.Listener {
                ...
                override fun onPlayerError(error: PlaybackException) {
                    ...
                    onError(error.message ?: streamInterruptedMessage)
                }
            }
